...
# will print the number / symbol on the screen that is pressed
...
# will calculate whats in calculation and print on screen
...
# will clear the screen when the C is pressed
def clear_field():
    global calculation
    calculation = ""
    text_result.delete(1.0, "end")
...
# making the buttons and the commands
